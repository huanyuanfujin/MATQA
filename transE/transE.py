...
def data_loader(file):
    file1 = file + "Source/reSource/train.txt"
    file2 = file + "Source/reSource/en2id.txt"
    file3 = file + "Source/reSource/re2id.txt"
...
class TransE:
    ...
    def train(self, epochs):
        ...
        for epoch in range(25000):
            ...
            if epoch > 0 and epoch % 48 == 0:
                print("写入文件...")
                with codecs.open("entity_50dim_batch4001", "w") as f1:
                    for e in self.entity.keys():
                        f1.write(e + "\t")
                        f1.write(str(list(self.entity[e])))
                        f1.write("\n")

                with codecs.open("relation50dim_batch4001", "w") as f2:
